<?php
class PinyinModel extends CI_Model{
	 ...
	 *    @return string
	 +---------------------------------------------------------------------------------
	 */
	public function getshorturlPY($chinese, $delimiter = '', $length = 0, $charset='utf-8') {
		...
		$newssssss = '';
		$newyin_str = str_replace('--', '-', $newyin_str);
		$sp = explode('-', $newyin_str);
		if(count($sp) >= 2){
...
//              return iconv('UTF-8', 'GB2312', $_String);
             return iconv('UTF-8', 'GBK//TRANSLIT', $_String);
	}
