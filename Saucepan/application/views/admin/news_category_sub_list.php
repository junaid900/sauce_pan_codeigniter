...
<table class="gksel_normal_tabaction">
	<tr>
		<td>
			<div class="searcharea">
				<a href="<?php echo base_url().'index.php/admins/news/toadd_news_subcategory/'.$parent.'?backurl='.$backurl.'&subbackurl='.$current_url_encode?>">
					<font class="nav_on">
						<font class="plus">
						...
						<td width="300" align="center" style="padding:0px;">
							<div style="float:right;">
								<?php 
									...
									$countthirdcategory = $this->NewsModel->getnewscategorylist($con, 1);
...
// 									}
									...
									echo '<a href="'.base_url().'index.php/admins/news/toedit_newssubcategory/'.$parent.'/'.$subcategorylist[$i]['category_id'].'?backurl='.$backurl.'&subbackurl='.$current_url_encode.'" class="gksel_btn_action_on">'.lang('cy_edit').'</a>';
									...
									if($subcategorylist[$i]['category_id'] == 95){
										...
										if($countthirdcategory > 0){
											...
											echo '<a onclick="todel_newscategory('.$subcategorylist[$i]['category_id'].', \''.$subcategorylist[$i]['category_name'.$this->langtype].'\')" href="javascript:;" class="gksel_btn_action_on">'.lang('cy_delete').'</a>';
										}
									}
