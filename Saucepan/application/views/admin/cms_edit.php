...
<form method="post">
	<table class="gksel_normal_tabpost">
		<tr>
			...
			<td align="left">
				<input type="text" name="cms_name_en" value="<?php echo $cmsinfo['cms_name_en']?>"/>
		...
		<tr>
			...
			<td align="left">
				<input type="text" name="cms_name_ch" value="<?php echo $cmsinfo['cms_name_ch']?>"/>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<textarea name="cms_description_en"><?php echo $cmsinfo['cms_description_en']?></textarea>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<textarea name="cms_description_ch"><?php echo $cmsinfo['cms_description_ch']?></textarea>
				<div class="tipsgroupbox"><div class="request">*</div></div>
			</td>
		</tr>
		<tr>
			...
			<td align="left">
				<div class="gksel_btn_action_on" onclick="tosave_cmsinfo(<?php echo $cmsinfo['cms_id']?>)"><?php echo lang('cy_save')?></div>
			</td>
		</tr>
	</table>
</form>
