...
<div  style="width: calc(100% - 20px);padding:15px 0px;margin-left:10px;margin-top:10px;box-shadow: 1px 1px 1px rgba(43,43,43,.3);float: left;text-align: center;color: #000;font-size: 14px;display:none;">
	<?php if($this->langtype == '_ch'){
				...
				$.ajax({
				 ...
				 success: function(data){
				    //函数参数 "data" 为请求成功服务端返回的数据
						...
						// var a =parseFormatNum(data.response.sp_points,1)
						$(".points_btn").click(function(){
							...
							$(".consumption_prompt_body .left_text").text("<?php if($this->langtype=='_ch'){echo "我有积分";}else{echo "You have SP points ";}?>"+data.response.sp_points)
