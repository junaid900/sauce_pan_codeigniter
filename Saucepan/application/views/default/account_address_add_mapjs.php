...
function toselectaddress_fromsearchaddresslist(i){
	...
	driving.search([121.432609,31.221933], [address_longitude, address_latitude], function(status, result) {
		console.log(result);
		...
		// 	}else{
			console.log("wo xiangzhidaozhes sm ",address_district)
		...
		if(address_district != 'Huangpu' && address_district != 'Minhang' && address_district != 'Xuhui' && address_district != 'Putuo' && address_district != 'Yangpu' && address_district != 'Changning' && address_district != 'Hongkou' && address_district != 'Jing\'an'){
