...
<style>
	...
	/* .addressdisplay{display: none !important;} */
</style>
...
<!-- <div class="inside extraSpace backButton" style="margin-top: 0px;">
...
<div style="position:absolute;top:0px;width:100%;max-width:750px;background:#465c62;z-index: 1111;" class="addressdisplay">
...
<div style="position:absolute;top:50px;bottom:25px;width:100%;max-width:750px;height:100%" class="addressdisplay">
...
<div class="cannot_deliverytips addressdisplay" style="display:none;position:absolute;top:160px;width:100%;max-width:750px;z-index:1000;" >
...
<div class="firstcomingin_deliverytips" style="position:absolute;top:50px;width:100%;max-width:750px;z-index:1000;" >
...
<div class="consumption_prompt_body" style="display: block;">
	<div class="body">
		...
		<div class="addrsss_section">
			...
			<div class="section_box" style="font-size: 16px;justify-content: center;width: 100%;flex-wrap: wrap;">
				<div>Lets proceed to update your details</div>
				<div>请添加一个收货地址</div>
...
<div class="loading_bg" style="width: 100%;height: 100%;position: fixed;top:0;left:0;background-color: white;z-index: 100000000000000;">
						...
						$.ajax({
						 ...
						 success: function(data){
						    //函数参数 "data" 为请求成功服务端返回的数据
								console.log('请求成功',data)  
								if(data!=null){
									window.location.href ="<?php echo base_url().'index.php/wechat/information_list'?>" ;
								}
						},
						});
					}
