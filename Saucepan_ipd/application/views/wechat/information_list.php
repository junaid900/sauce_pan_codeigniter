...
<div class="new_saucepan" style="display: block;">
	<div class="new_saucepan_body">
		...
		<div class="input_box">
			<input placeholder="Please enter your Phone"  type="text" name="first_name"/>
			<input placeholder="Please enter your Email"  type="text" name="phone" />
			<input placeholder="Please enter your Name"   type="text" name="email"/>
		</div>
			 ...
			 if(timestamp>timestamp1){
				...
				$(".btn").click(function(){
					if($("input[name='first_name']").val()==''){
						$(".consumption_prompt_body .section_box").text("<?php if($this->langtype=='_ch'){echo "名字不能为空";}else{echo "Name cannot be empty";}?>")
