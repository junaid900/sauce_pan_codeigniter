...
<div style="position:absolute;top:107px;height:48px;width:100%;max-width:750px;background:#465c62;">
	<div style="float:left;width:calc(100% - 20px);margin-left:10px;margin-top:6px;">
		<form action="javascript:;">
		
			<input id="address_dingwei" name="address_dingwei" class="address_dingwei" placeholder="<?php if($this->langtype == '_ch'){/*echo '搜索商店，城市，州或邮编';*/echo '搜索地址';}else{/*echo 'Search store, city, state, or zip';*/echo 'Search address or nearby';}?>" type="text" value="" style="background:#fdf3f2;border:0px;outline: none;"/>
...
<div style="position:absolute;top:154px;bottom:25px;width:100%;max-width:750px;height:100%">
...
<div class="cannot_deliverytips" style="display:none;position:absolute;top:110px;width:100%;max-width:750px;z-index:1000;">
...
<script type="text/javascript">
	...
	function toadd_newaddress2(){
		...
		var address_dingwei = $('input[name="address_dingwei"]').val();
		var address_otherdetail = $('input[name="address_otherdetail"]').val();
		var address_marked = $('input[name="address_marked"]').val();//user_address_cs
		var ss=address_district+address_formattedaddress;
		console.log(ss,"ss");return;
		// if(address_otherdetail != ''){
		// 	$('.addnewaddress_submit').hide();
		// 	$('.addnewaddress_loading').show();
		// 	$.ajax({
