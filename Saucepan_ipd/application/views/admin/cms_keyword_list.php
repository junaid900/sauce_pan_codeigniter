			...
			<table class="gksel_normal_tablist" style="margin-top: 0px;">
				<tbody>
					<tr>
						...
						<td>
							<?php echo actionsearchdaxiaoxiezimu($keyword, strip_tags($keywordlist[$i]['keyword_name'.$this->langtype]));?>
						</td>
						...
						<td width="300" align="center" style="padding:0px;">
							<div style="float:right;">
								<?php 
									...
									echo '<a onclick="todel_keyword('.$keywordlist[$i]['keyword_id'].', \''.$keywordlist[$i]['keyword_name'.$this->langtype].'\')" href="javascript:;" class="gksel_btn_action_on">'.lang('cy_delete').'</a>';
								?>
							</div>
						</td>
					</tr>
