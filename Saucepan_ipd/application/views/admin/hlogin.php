			...
			<td width="50%" valign="middle" align="right">
				<div style="float:right;margin-right:70px;">
					<a href="<?php echo base_url().'index.php/admin/index'?>">
						<img height="80" src="<?php echo CDN_URL().'themes/default/images/ezdesign_logo.png'?>"/>
					</a>
				</div>	
						...
						<form name="loginform" action="<?php echo base_url().'index.php/admin/tologin'?>" method="post">
							<table cellpadding="0" cellspacing="0" border=0 style="color:white; font-weight:bolder; margin-left:20px;">
								...
								<tr>
									...
									<td>
										<input style="float:left;border:0;width:60px;height:30px;background:rgb(171,16,50);color:white;font-weight:bold;" type="submit" value=" Login "  />
