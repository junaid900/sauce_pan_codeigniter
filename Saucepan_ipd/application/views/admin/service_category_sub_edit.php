...
<form method="post">
	<table class="gksel_normal_tabpost">
		<?php for ($lc = 0; $lc < count($lancodelist); $lc++) {?>
			<tr>
				<td align="right" width="150"><?php if($this->langtype == '_ch'){echo '子分类名称';}else{echo 'Subcategory Name';}?> <?php if(count($lancodelist) != 1){echo '('.$lancodelist[$lc]['langname'].')';}?></td>
				<td align="left">
		...
		<tr>
			...
			<td align="left">
				<div class="gksel_btn_action_on" onclick="tosave_servicesubcategoryinfo(<?php echo $parent?>, <?php echo $categoryinfo['category_id']?>)"><?php echo lang('cy_save')?></div>
			</td>
		</tr>
	</table>
</form>
