...
<table class="gksel_normal_tabaction">
	<tr>
		<td>
			<div class="searcharea">
				<a href="<?php echo base_url().'index.php/admins/event/toadd_event_subcategory/'.$parent.'?backurl='.$backurl.'&subbackurl='.$current_url_encode?>">
					<font class="nav_on">
						<font class="plus">
						...
						<span><?php if($this->langtype == '_ch'){echo '添加标签';}else{echo 'Add label';}?></span>
					</font>
				</a>
			</div>
		</td>
...
<table class="gksel_normal_tablist">
	<thead>
		<tr>
			...
			<td><p>&nbsp;&nbsp;&nbsp;<?php if($this->langtype == '_ch'){echo '标签名称';}else{echo 'Label Name';}?></p></td>
						...
						<td width="300" align="center" style="padding:0px;">
							<div style="float:right;">
								<?php 
									...
									$countthirdcategory = $this->EventModel->geteventcategorylist($con, 1);
...
// 									}
									...
									echo '<a href="'.base_url().'index.php/admins/event/toedit_eventsubcategory/'.$parent.'/'.$subcategorylist[$i]['category_id'].'?backurl='.$backurl.'&subbackurl='.$current_url_encode.'" class="gksel_btn_action_on">'.lang('cy_edit').'</a>';
									...
									if($subcategorylist[$i]['category_id'] == 95){
										...
										if($countthirdcategory > 0){
											...
											echo '<a onclick="todel_eventcategory('.$subcategorylist[$i]['category_id'].', \''.$subcategorylist[$i]['category_name'.$this->langtype].'\')" href="javascript:;" class="gksel_btn_action_on">'.lang('cy_delete').'</a>';
										}
									}
