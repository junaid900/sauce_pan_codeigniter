...
<form method="post">
	<table class="gksel_normal_tabpost">
		<tr>
			<td align="right" width="150"><?php if($this->langtype == '_ch'){echo '关键词';}else{echo 'Keyword';}?> (English)</td>
			<td align="left">
		...
		<tr>
			<td align="right" width="150"><?php if($this->langtype == '_ch'){echo '关键词';}else{echo 'Keyword';}?> (中文)</td>
			<td align="left">
