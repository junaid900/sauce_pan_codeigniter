	...
	<tr>
		<td>
			<div style="float:left;">
				<div onclick="javascript:location.href='<?php echo base_url().'index.php/admins/report/daily_summary?islive=1'?>';" style="cursor:pointer;float:left;margin-left:5px;margin-top:-4px;<?php if($islive == 1){echo 'background:rgb(171,16,50);color:white;';}else{echo 'background:#CCC;color:gray;';}?>font-size:12px;padding:6px 8px;">
					Live dates <span style="color:green;">(<?php echo $count_live?>)</span>
				</div>
				<div onclick="javascript:location.href='<?php echo base_url().'index.php/admins/report/daily_summary?islive=0'?>';" style="cursor:pointer;float:left;margin-left:5px;margin-top:-4px;<?php if($islive == 0){echo 'background:rgb(171,16,50);color:white;';}else{echo 'background:#CCC;color:gray;';}?>font-size:12px;padding:6px 8px;">
		...
		<td>
			<div class="searcharea">
				<form action = "<?php echo base_url().'index.php/admins/report/daily_summary'?>" method="get">
					<?php 
					...
					<input type="text" name="select_date" style="width:100px;" placeholder="Select date" value="<?php echo $select_date;?>"/>
