							...
							<div style="float:right;">
								<?php 
									...
									if($countsubcategory > 0){
										...
										echo '<a onclick="todel_productcategory('.$categorylist[$i]['category_id'].', \''.$categorylist[$i]['category_name'.$this->langtype].'\')" href="javascript:;" class="gksel_btn_action_on">'.lang('cy_delete').'</a>';
									}
								?>
							</div>
						</td>
