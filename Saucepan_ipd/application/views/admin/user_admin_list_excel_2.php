	...
	echo '<html xmlns:o="urn:schemas-microsoft-com:office:office"
		...
		<div id="Classeur1_16681" align=center x:publishsource="Excel">
			<table x:str border=0 cellpadding=0 cellspacing=0 style="font-family: Calibri, Helvetica, SimSun, sans-serif;border-collapse: collapse;">
				...
				<tr>
					<th style="min-height:30px;border:.5pt solid windowtext;background:rgb(171,16,50);" height="30" align="center" class="xl2216681 nowrap">N/A</th>
					<th style="min-height:30px;border:.5pt solid windowtext;background:rgb(171,16,50);" align="center" class="xl2216681 nowrap">Username</th>
					<th style="min-height:30px;border:.5pt solid windowtext;background:rgb(171,16,50);" align="center" class="xl2216681 nowrap">Email</th>
					<th style="min-height:30px;border:.5pt solid windowtext;background:rgb(171,16,50);" align="center" class="xl2216681 nowrap">Phone</th>
					<th style="min-height:30px;border:.5pt solid windowtext;background:rgb(171,16,50);" align="center" class="xl2216681 nowrap">Sex</th>
					<th style="min-height:30px;border:.5pt solid windowtext;background:rgb(171,16,50);" align="center" class="xl2216681 nowrap">Last Edited Time</th>
					<th style="min-height:30px;border:.5pt solid windowtext;background:rgb(171,16,50);" align="center" class="xl2216681 nowrap">Author</th>
				</tr>';
				//选择数据--开始
