		...
		<?php for ($lc = 0; $lc < count($lancodelist); $lc++) {?>
			<tbody>
				<tr>
					...
					<td align="left">
						<input type="text" name="article_name<?php echo $lancodelist[$lc]['langtype']?>" style="width:300px;" value=""/>
				...
				<tr>
        			<td align="right" width="150"><?php if($this->langtype == '_ch'){echo '简介';}else{echo 'Tagline';}?></td>
        			  ...
        			  <td>
                          <textarea style="float:left;width:400px;height:50px;" name="article_tagline<?php echo $lancodelist[$lc]['langtype']?>"></textarea>
        			  </td>
        		</tr>
				<tr>
					...
					<td align="left">
						<script id="article_description<?php echo $lancodelist[$lc]['langtype']?>" type="text/plain" style="width:800px;height:300px;"></script>
	...
	function toadd_articleinfo(){
		...
		if(isajaxsaveing == 0){
			...
			if(returnOBJ.ispass == 1){
				$.post(baseurl+'index.php/admins/article/add_article', postOBJ, function (data){
					var obj = eval( "(" + data + ")" );
