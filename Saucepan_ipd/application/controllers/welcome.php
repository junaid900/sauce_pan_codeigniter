...
//  		$data["whowearelist"] = $this->WhoweareModel->getwhowearelist($con);
		$this->load->view ( 'systemipd/admin_login');
	}
	...
	function systemipd(){
		$this->session->set_userdata ( 'menu', 'home' );
		$data ['website_title'] = 'saucepan';
		$this->load->view('systemipd/home');
	}
	function systemipd_order(){
		$this->session->set_userdata ( 'menu', 'order' );
		$data ['website_title'] = 'saucepan';
		$this->load->view('systemipd/order_list');
	}
	function systemipd_order_history(){
        $this->session->set_userdata ( 'menu', 'order_history' );
        $data ['website_title'] = 'saucepan';
        $this->load->view('systemipd/order_history_list');
    }
	function systemipd_order_preorder(){
		$this->session->set_userdata ( 'menu', 'order_preorder' );
		$data ['website_title'] = 'saucepan';
		$this->load->view('systemipd/order_preorder');
	}
    function systemipd_customers(){
        $this->session->set_userdata ( 'menu', 'customers' );
        $data ['website_title'] = 'saucepan';
        $this->load->view('systemipd/customers_list');
    }
    function systemipd_products(){
        $this->session->set_userdata ( 'menu', 'products' );
        $data ['website_title'] = 'saucepan';
        $this->load->view('systemipd/product_list');
    }
    function systemipd_attributes(){
        $this->session->set_userdata ( 'menu', 'attributes' );
        $data ['website_title'] = 'saucepan';
        $this->load->view('systemipd/attribute_list');
    }
	function systemipd_login(){
		$this->session->set_userdata ( 'menu', 'about' );
		$data ['website_title'] = 'saucepan';
		$this->load->view('systemipd/admin_login');
	}
