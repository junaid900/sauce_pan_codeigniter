<?php $labels =  $this->db->get('notices')->result_array(); ?>
<div class="card">
	<h3 class="card-header mt-0"><i class="fa fa-plus"></i> <?php echo get_phrase('add_notice'); ?></h3>
	<div class="card-body">
		<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/manage_notices/add'; ?>" method="post"  enctype ='multipart/form-data'>
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<textarea name="ch_description" class="form-control" required></textarea>
				</div>
			</div>
