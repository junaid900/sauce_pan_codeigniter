<?php $labels =  $this->db->get('category')->result_array(); ?>
<div class="card">
	<h3 class="card-header mt-0"><i class="fa fa-plus"></i> <?php echo get_phrase('add_sub_category'); ?></h3>
	<div class="card-body">
		<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/manage_sub_category/add'; ?>" method="post"  enctype ='multipart/form-data'>
