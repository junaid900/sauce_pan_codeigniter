<?php 
    $details = $this->db->get_where('sub_category', array('sub_category_id'=>$param1))->row_array();  
    $labels =  $this->db->get('category')->result_array(); 
?>
...
<div class="row">
	<div class="col-md-12"> 
		<div class="card">
			...
			<div class="card-body">
			<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/manage_sub_category/edit/'.$param1; ?>" method="post"  enctype ='multipart/form-data'>
					    <div class="form-group row">
            				...
            				<div class="col-sm-8">
            					<select id="category_id" name="category_id" required="required" class="form-control">
            						...
            						<option value="<?php echo $lbl['category_id']; ?>" <?php if($details['category_id'] == $lbl['category_id']) echo 'selected'; ?>> <?php echo $lbl['en_title']; ?> -- <?php echo $lbl['ch_title']; ?></option>
            						<?php } ?>
            					</select>
            				</div>
            			</div>
