    ...
    <div>
        ...
        <ol class="page_tree">
            <li class="breadcrumb-item">
                <a href="<?= base_url() . admin_ctrl() . "/manage_product" ?>"><?= $page_title ?></a>
            </li>
            <!--            <li class="breadcrumb-item">-->
            <!--                <a>Tables</a>-->
            <!--            </li>-->
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <form role="form" method="post"
                                  action="<?= base_url() . admin_ctrl() . "/" . $page_name . "/save/".$sel_pr_data->product_id ?>" enctype="multipart/form-data">
                                            ...
                                            foreach ($categories as $category) {
                                                ...
                                                <label class="radio-item budget__option">
                                                    <input type="radio" name="category"
                                                           ...
                                                           class="radio-item__input budget__input preset-value" <?php if($category->category_id ==  $sel_pr_data->category_id){ echo 'checked';}?>>
...
<!--                                                </div>-->
                                ...
                                <div class="modal fade" id="exampleModal" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"><?=get_phrase("manage_product_category")?></h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                        ...
                                                        foreach ($sub_categories as $category) {
                                                            ...
                                                            <label class="radio-item budget__option">
                                                                <input type="checkbox" name="product_category[]"
                                                                       ...
                                                                       class="radio-item__input budget__input preset-value" id="pr_cat_<?= $category->product_category_id ?>">
                                                                <span class="radio-item__label-text">
                                ...
                                <div class="row input-container">
                                    ...
                                    <div class="col-sm-9 row drg-div" id="pc_button_item"></div>
                                </div>
                                <div class="row input-container">
                                ...
                                <div class="row input-container">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="upload-btn-img">
                                            <?php if(!empty($sel_pr_data->product_image)){ ?>
                                            <img src="<?php echo base_url().$sel_pr_data->product_image; ?>"
                                                        ...
                                                        foreach ($watermarks as $watermark) {
                                                            ...
                                                            <label class="radio-item budget__option">
                                                                <input type="checkbox" name="watermarks[]"
                                                                       ...
                                                                       class="radio-item__input budget__input preset-value"
                                                                       <?php
                                                                        foreach($p_watermarks as $p_watermark){
                                                                            if($p_watermark->product_watermark_id == $watermark->product_watermark_id){
                                                                                echo "checked";
                                                                                break;
                                                                            }
                                                                        }
					...
					<option value="1">Please select some printer group</option>
                                       <?php foreach($printer_group as $group){?>
                                            <option value = "<?=$group->printer_group_id?>" <?=$sel_pr_data->printer_group_id == $group->printer_group_id?'selected':'' ?>><?=$group->group_title?></option>
                                       <?php } ?>
                                   </select>
                                </div>
                                <div class="row input-container">
                                    ...
                                    <input type="number"
                                           ...
                                           name="or_price"
                                           class="form-control col-sm-9" value="<?php echo $sel_pr_data->original_price; ?>" required>
                                </div>
                                ...
                                <div class="row input-container">
                                    ...
                                    <input type="number"
                                           ...
                                           name="cur_price"
                                           class="form-control col-sm-9" value="<?php echo $sel_pr_data->current_price; ?>" required>
                                </div>
                                ...
                                <div class="row input-container">
                                    ...
                                    <input type="text"
                                           placeholder="<?=get_phrase("name")?>"
                                           name="name_en"
                                           class="form-control col-sm-9" value="<?php echo $sel_pr_data->product_name_en; ?>" required>
                                </div>
                                ...
                                <div class="row input-container">
                                    ...
                                    <input type="text"
                                           placeholder="名称"
                                           name="name_ch"
                                           class="form-control col-sm-9" value="<?php echo $sel_pr_data->product_name_ch; ?>"  required>
                                </div>
                                <div class="row input-container">
                                    ...
                                    <div class = 'col-sm-9 text-area-container'>
                                        <textarea type="text"
                                                  ...
                                                  name="text_en"
                                                  class="form-control col-sm-9" rows="6"   required><?php echo $sel_pr_data->product_detail_en; ?></textarea>
                                    </div>
                                </div>
                                <div class="row input-container">
                                    ...
                                    <div class = 'col-sm-9 text-area-container'>
                                        <textarea type="text"
                                                  placeholder="名称"
                                                  name="text_ch"
                                                  class="form-control col-sm-9" rows="6"   required><?php echo $sel_pr_data->product_detail_ch; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row input-container">
                                    ...
                                    <div class="toggle-btn2  <?php if($sel_pr_data->status =='Online'){ echo 'active'; } ?>">
                                        <input type="checkbox" class="cb-value1" name="status" value="active" <?php if($sel_pr_data->status =='Online'){ echo 'checked'; } ?> />
...
<script>
    ...
    function filterProducts(){
        ...
        for(var i = 0 ; i < productArray.length ; i++ ){
            $("#p_button_item").append('<div><button type="button" class="btn btn-outline-success  pc-button-item" disabled>' + productArray[i].product.product_name_en + '</button><i class="fa fa-remove rm_icon" onclick="removeProduct('+i+')"></i></div>');
        }
    }
    ...
    function removeProduct(index){
        document.getElementById('pp_'+productArray[index].product.product_id).click();
       filterProducts();

    }
    function removeAttr(index){
        document.getElementById('pr_cat_'+attrArray[index].catData.product_category_id).click();
    ...
    function manage_categories_in_main() {
        ...
        for (var i = 0; i < attrArray.length; i++) {
            $("#pc_button_item").append(' <div class = "drg-sub-div" id = "sub'+i+'"><input type="hidden" id = "input_sub'+i+'" name="p_cat['+i+']" value = "'+attrArray[i].catData.product_category_id+'"/> <p class="btn btn-outline-success  pc-button-item" disabled>' + attrArray[i].catData.product_category_title_en + '</p><i class="fa fa-remove rm_icon" onclick="removeAttr('+i+')"></i></div>');
        }
        for (var j = 0; j < attrArray.length; j++) {
            atrdata = attrArray[j].catData;
            console.log(atrdata);
...
setTimeout(function(){ 
    <?php  
       foreach($sel_pr_cat_data as $pr){ 
    ?>
    document.getElementById('pr_cat_<?php echo $pr['product_category_id'] ?>').click();
    <?php 
       }
    ?>
    <?php
    foreach($suggested_products as $pr1){
            ?>
        document.getElementById('pp_<?php echo $pr1->suggested_product_id ?>').click();
        <?php
           }
        ?>
}, 200); 
