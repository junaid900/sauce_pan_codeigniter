                        ...
                        <table class="custom-table dataTables-example">
                            ...
                            foreach ($table_data as $category) {
                                ...
                                <tr class="gradeX row_<?php echo $category->status; ?>"
                                    id="<?php echo $category->product_category_id; ?>">
                                    <td><?= $i ?></td>
                                    <td><?= $category->product_category_title ?></td>
                                        ...
                                        <div class="table-toggle">
                                            <div class="toggle-btn1 <?php if ($category->status == 'Online') {
                                                ...
                                                <input type="checkbox" class="cb-value"
                                                       value="<?php echo $category->product_category_id; ?>" <?php if ($category->status == 'Online') {
                                                    echo 'checked';
                                                } ?>/>
                                    ...
                                    <td class="center">
                                        <a href="<?= base_url() . admin_ctrl() . '/' . $page_name . '/edit/' . $category->product_category_id ?>">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="javascript:;"
                                           onclick="confirm_modal_action('<?php echo base_url() . admin_ctrl() ?>/<?= $page_name ?>/delete/<?php echo $category->product_category_id; ?>');">
