                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-10 col-lg-8">
                            <form role="form" method="post"
                                  action="<?= base_url() . admin_ctrl() . "/" . $page_name . "/update/" . $category->product_attribute_id ?>">
                                            ...
                                            foreach ($sizes as $size) {
                                                ...
                                                <label class="radio-item budget__option">
                                                    <input type="checkbox" name="size_id[]"
                                                           ...
                                                           <?php 
                                                            foreach($atts as $att){
                                                                if($att->product_attribute_size_id == $size->attribute_size_id){
                                                                    echo "checked";
                                                                    break;
                                                                }
                                                            }
          ...
          <span class="budget__amount"><?= $size->name . " (" . $size->size . ")"  ?></span>
                                ...
                                <div class="row input-container">
                                    ...
                                    <select class="form-control col-sm-9" name="printer_group">
                                        ...
                                        foreach ($printer_groups as $group) {
                                            ?>
                                            <option value="<?= $group->printer_group_id ?>" <?= $group->printer_group_id == $category->printer_group_id ? "selected" : "" ?>><?= $group->group_title ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="row input-container">
                                    ...
                                    <select class="form-control col-sm-9" name="category">
                                        ...
                                        foreach ($sub_data as $sub_d) {
                                            ?>
                                            <option value="<?= $sub_d->product_category_id ?>" <?= $sub_d->product_category_id == $category->product_category_id ? "selected" : "" ?>><?= $sub_d->product_category_title_en . " " . "(" . $sub_d->product_category_title_ch . ")" ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                
                                <div class="row input-container">
                                    <label class="col-sm-3"><?= get_phrase("original_price") ?>
                                    </label>
                                    <input type="text"
                                           placeholder="<?= get_phrase("original_price") ?>"
                                           name="or_price"
                                           class="form-control col-sm-9"
                                           value="<?= $category->original_price ?>"
                                           required>
                                </div>
                                <div class="row input-container">
                                    <label class="col-sm-3"><?= get_phrase("current_price") ?>
                                    </label>
                                    <input type="text"
                                           placeholder="<?= get_phrase("current_price") ?>"
                                           name="cur_price"
                                           class="form-control col-sm-9"
                                           value="<?= $category->current_price ?>"
                                           required>
                                </div>
                                <div class="row input-container">
                                    ...
                                    <input type="text"
                                           ...
                                           name="name_en"
                                           value="<?= $category->product_attribute_title_en ?>"
                                ...
                                <div class="row input-container">
                                    ...
                                    <input type="text"
                                           placeholder="名称"
                                           name="name_ch"
                                           value="<?= $category->product_attribute_title_ch ?>"
                                           class="form-control col-sm-9" required>
                                </div>
                                ...
                                <div class="row input-container">
                                    ...
                                    <div class="toggle-btn2 <?= $category->tb_status == 'Online' ? 'active' : '' ?>">
                                        <input type="checkbox" class="cb-value1" name="status"
                                               value="active" <?= $category->tb_status == 'Online' ? "checked" : "" ?>/>
