                            ...
                            <form role="form" method="post"
                                            ...
                                            foreach ($frequencies as $freq) {
                                                ...
                                                <div class="checkbox checkbox-info checkbox-circle">
                                                    <input id="checkbox<?= $j ?>" type="checkbox" name="frequency[]"
                                                           checked="" value="<?= $freq->coupon_frequency_id ?>">
                                ...
                                <div class="row input-container">
                                    ...
                                    <div class="row">
                                        <div class="radio radio-info">
                                            <input type="radio" id="coupon" value="Coupon" name="c_type"  onchange="onCType(event)" checked = "">
                                            <label for="coupon"> <?=get_phrase("coupon")?> </label>
                                        </div>
                                        <div class="radio radio-info">
                                            <input type="radio" id="voucher" value="Voucher" name="c_type" onchange="onCType(event)">
                                            <label for="voucher"> <?=get_phrase("voucher")?> </label>
                                        </div>

                                    </div>
                                </div>
                                <div class="row input-container" id="voucher_password" style="display: none">
                                    ...
                                    <div class="row col-sm-9">
                                        ...
                                        <div class = "col-sm-5">
                                            <div class="input-group" data-autoclose="true">
                                                <input name="start_time" type="text" class="form-control" value="00:00:00">
                                                <span class="input-group-addon">
                                ...
                                <div class="row input-container">
                                    ...
                                    <div class="row col-sm-9">
                                        <div class="col-sm-7">
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="end_date" class="form-control" value="<?=date("m-d-Y")?>">
                                            </div>
                                            <div>
                                                <label  style = "color:red">mm-dd-yyyy</label>
                                            </div>
                                        ...
                                        <div class = "col-sm-5">
                                            <div class="input-group clockpicker " data-autoclose="true">
                                                <input type="text" name="end_time" class="form-control" value="00:00:00">
                                                <span class="input-group-addon">
                                                    <span class="fa fa-clock-o"></span>
                                                </span>
                                            </div>
                                ...
                                <div class="row input-container">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="radio radio-info">
                                           <input type="radio" id="for_pro" value="For Products" name="type" onchange="onChangeType(event)">
                                ...
                                <div class="row input-container" style="display: none" id="product_div">
