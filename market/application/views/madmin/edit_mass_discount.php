                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-10 col-lg-8">
                            <form role="form" method="post"
                                  action="<?= base_url() . admin_ctrl() . "/" . $page_name . "/update/".$coupon->mass_discount_id ?>">
                                
                                <div class="row input-container">
                                    <label class="col-sm-3"><?= get_phrase("mass_discount_name") ?> </label>
                                    <input type="text"
                                           placeholder="<?= get_phrase("mass_discount_name") ?>"
                                           name="name"
                                           value="<?=$coupon->mass_discount_name?>"
...
<!--                                --><?php //print_r($coupon);?>
                                <div class="row input-container">
                                    ...
                                    <input type="number"
                                           ...
                                           name="discount"
                                           value="<?=$coupon->discount_type == "Cash"?$coupon->amount:$coupon->percentage?>"
                                           class="form-control col-sm-9" required>
                                </div>
                                ...
                                <div class="row input-container">
                                    ...
                                    <div class="row col-sm-9">
                                        ...
                                        <div class="input-group clockpicker2 col-sm-5" data-autoclose="true">
                                            <input name="start_time" type="text" class="form-control" value="<?="12:00"?>" >
