                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12 col-md-10 col-lg-8">
                            <form role="form" method="post" action="<?=base_url().admin_ctrl()."/".$page_name."/update/".$data->product_watermark_id?>" enctype="multipart/form-data">
                                ...
                                <div class="row input-container">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="upload-btn-img">
                                            <img src="<?php echo base_url().$data->watermark_url; ?>"
