...
<div class="wrapper">
	...
	<div class="alert alert-info" style="width:100%">
	  <strong><?php echo get_phrase('info!'); ?></strong> <?php echo get_phrase('this_page_allows_you_to_add_campus_information'); ?>
	</div>
    <div class="row">
        <form role="form" method="POST" action="<?php echo base_url().strtolower($this->session->userdata('directory')); ?>/add_campus_life/add"  enctype="multipart/form-data">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="en_short_description" placeholder="English short description" required>
                    </div>
                    <div class="form-group">
                        <label><?php echo get_phrase('chinese_short_description'); ?>:</label>
                        <input type="text" class="form-control"  name="ch_short_description" placeholder="Chinese short description" required>
                    </div>
                    <div class="form-group">
                        	...
                        	<textarea rows="5" cols="5" name="en_description" class="form-control summernote"
									  placeholder="en_description" required>
						    </textarea>
                    </div>
                    <div class="form-group">
                        	...
                        	<textarea rows="5" cols="5" name="ch_description" class="form-control summernote"
									  placeholder="ch_description" required>
						    </textarea>
                    </div>
                     <div class="form-group ">
