...
<div class="wrapper">
    ...
    <div class="row">
        <form role="form" method="POST" action="<?php echo base_url().strtolower($this->session->userdata('directory')); ?>/edit_news_category_detail/edit/<?php echo $page_data->news_category_detail_id; ?>"  enctype="multipart/form-data">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                    	<div class="upload-btn-img">
    						...
    						<?php }else{ ?>
    							<img src="<?php echo base_url(); ?>uploads/news/<?php echo $page_data->image; ?>"  class="img-thumbnail p-0 m-0">
    						<?php } ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control col-sm-10"  name="en_title" placeholder="English Title" value="<?php echo $page_data->en_title; ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"><?php echo get_phrase('chinese_title'); ?>:</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control col-sm-10"  name="ch_title" placeholder="Chinese Title" value="<?php echo $page_data->ch_title; ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
        				<label class="col-sm-2 col-form-label"><?php echo get_phrase('news_category'); ?></label>
        				<div class="col-sm-10">
        					<select id="category_id" name="category_id" required="required" class="form-control" onchange="getSubcategory(this.value)" required>
        						...
        						<option value="<?php echo $lbl['news_category_id']; ?>" <?php if($lbl['news_category_id'] == $page_data->news_category_id){ echo 'selected'; } ?>> <?php echo $lbl['en_title']; ?> -- <?php echo $lbl['ch_title']; ?></option>
        						<?php } ?>
        					</select>
        				</div>
        			</div>
                    <div class="form-group row">
        				<label class="col-sm-2 col-form-label"><?php echo get_phrase('news_sub_category'); ?></label>
        				<div class="col-sm-10">
        					...
        					<option value="" disabled selected><?php echo get_phrase('please_select'); ?></option>
        						...
        						<option value="<?php echo $lbl['news_sub_category_id']; ?>" <?php if($lbl['news_sub_category_id'] == $page_data->news_sub_category_id){ echo 'selected'; } ?>> <?php echo $lbl['en_title']; ?> -- <?php echo $lbl['ch_title']; ?></option>
        						<?php } ?>
        					</select>
        				</div>
        			</div>
                    <div class="form-group row">
        				<label class="col-sm-2 col-form-label"><?php echo get_phrase('news_sub_tree_category'); ?></label>
        				<div class="col-sm-10">
        					<select id="sub_tree_category_id" name="sub_tree_category_id" class="form-control">
        					    <option value="" disabled selected><?php echo get_phrase('please_select'); ?></option>
        						<?php foreach($sub_tree_category as $lbl){ ?>
        						<option value="<?php echo $lbl['news_sub_tree_category_id']; ?>" <?php if($lbl['news_sub_tree_category_id'] == $page_data->news_sub_tree_category_id){ echo 'selected'; } ?>> <?php echo $lbl['en_title']; ?> -- <?php echo $lbl['ch_title']; ?></option>
        						<?php } ?>
        					</select>
        				</div>
        			</div>
