<?php $details = $this->db->get_where('news_category', array('news_category_id'=>$param1))->row_array();  ?>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<h4 class="card-header mt-0"><i class="fa fa-pencil"></i><?php echo get_phrase('edit_news_category'); ?></h4>
			<div class="card-body">
			<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/manage_news_category/edit/'.$param1; ?>" method="post"  enctype ='multipart/form-data'>
