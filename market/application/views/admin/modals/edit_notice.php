<?php 
    $details = $this->db->get_where('notices', array('notices_id'=>$param1))->row_array(); 
?>

<div class="row">
	<div class="col-md-12"> 
		<div class="card">
			<h4 class="card-header mt-0"><i class="fa fa-pencil"></i><?php echo get_phrase('edit_notice'); ?></h4>
			<div class="card-body">
			<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/manage_notices/edit/'.$param1; ?>" method="post"  enctype ='multipart/form-data'>
        			    ...
        			    <div class="form-group row">
            				<label class="col-sm-4 col-form-label"><?php echo get_phrase('english_description'); ?></label>
            				<div class="col-sm-8">
            					<textarea name="en_description" class="form-control"  required><?php echo $details['en_description']; ?></textarea>
            				</div>
            			</div>
            			
            			<div class="form-group row">
            				<label class="col-sm-4 col-form-label"><?php echo get_phrase('chinese_description'); ?></label>
            				<div class="col-sm-8">
            					<textarea name="ch_description" class="form-control"   required><?php echo $details['ch_description']; ?></textarea>
            				</div>
            			</div>
