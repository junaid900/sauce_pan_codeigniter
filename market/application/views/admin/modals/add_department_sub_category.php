<?php $labels =  $this->db->get('department_category')->result_array(); ?>
<div class="card">
	<h3 class="card-header mt-0"><i class="fa fa-plus"></i> <?php echo get_phrase('add_category'); ?></h3>
	<div class="card-body">
		<form action="<?php echo base_url().strtolower($this->session->userdata('directory')). '/manage_department_sub_category/add'; ?>" method="post"  enctype ='multipart/form-data'>
			
			<div class="form-group row">
				<label class="col-sm-4 col-form-label"><?php echo get_phrase('category'); ?></label>
				<div class="col-sm-8">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" name="en_title" class="form-control" placeholder="<?php echo get_phrase('please_enter_category_title'); ?>" required>
				</div>
			</div>
		    ...
		    <div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" name="ch_title" class="form-control" placeholder="<?php echo get_phrase('please_enter_category_title'); ?>" required>
				</div>
			</div>
