   ...
   <div class="header-section">
    ...
    <div class="icon-logo dark-logo-bg hidden-xs hidden-sm">
        <a href="<?php echo base_url(); ?>">
           <?php if(!empty($system_image)){ ?>
            <img src="<?php echo base_url(); ?>uploads/admin/<?php echo $system_image; ?>" style="width:45px;" alt="">
            <?php }else{ ?>
            <img src="https://via.placeholder.com/150" alt="">
            <?php } ?>
        </a>
    ...
    <div id="navbar-collapse-1" class="navbar-collapse collapse yamm mega-menu">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> <?php echo $current_language; ?>  <b
                    class=" fa fa-angle-down"></b></a>
                <ul role="menu" class="dropdown-menu language-switch">
                    <li>
                        <a tabindex="-1" href="javascript:;" onclick="getLanguage('chinese')"><span> <?php echo get_phrase('chinese'); ?> </span></a>
                    </li>
                    <li>
                        <a tabindex="-1" href="javascript:;" onclick="getLanguage('english')"><span> English </span> </a>
                    </li>
        ...
        <ul class="notification-menu">
            ...
            <li>
                <a href="javascript:;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    ...
                    <img src="<?php echo base_url(); ?>uploads/users/<?php echo $user_data->user_image; ?>" alt="">
                    <?php }else{ ?>
                ...
                <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                    <li><a href="<?php echo base_url(); ?>admin/myprofile">  Profile</a></li>
                    <li>
