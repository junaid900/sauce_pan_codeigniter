...
<div class="wrapper">
    <div class="row">
        <div class="col-sm-12">
            ...
            <tr class="row_<?php echo $t['status']; ?>" id="<?php echo $t['news_id']; ?>">
                <td id="counter_<?php echo $t['news_id']; ?>">
                    <?php echo $count; ?>
                </td>
                <td>
                    <?php echo $t['en_title']; ?>
                ...
                <td>
                    <img src="<?php echo base_url(); ?>uploads/news/<?php echo $t['image']; ?>" width="80px">
                </td>
                <td>
                    <?php echo $t['date']; ?>
                </td>
