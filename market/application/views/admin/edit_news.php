...
<div class="wrapper">
	<div class="alert alert-info" style="width:100%">
	  <strong><?php echo get_phrase('info!'); ?></strong> <?php echo get_phrase('this_page_allows_you_to_edit_news_information'); ?>
	</div>
    <div class="row">
        <form role="form" method="POST" action="<?php echo base_url().strtolower($this->session->userdata('directory')); ?>/edit_news/edit/<?php echo $page_data->news_id; ?>"  enctype="multipart/form-data">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="tag_input">
                          <?php foreach($en_keywords as $words){ ?>
                          ...
                          <?php } ?>
                          <div class="tag_input_field" contenteditable data-placeholder="Tags" required></div>
                        </div>
                    </div>
                     <div class="form-group ">
                        ...
                        <div class="tag_input_two">
                          ...
                          <?php } ?>
                          <div class="tag_input_field_two" contenteditable data-placeholder="Tags" required></div>
                        </div>
                    </div> 
