...
<div class="wrapper">
	<div class="alert alert-info" style="width:100%">
	  <strong><?php echo get_phrase('info!'); ?></strong> <?php echo get_phrase('this_page_allows_you_to_add_your_news_category_detail_information'); ?>
	</div>
    <div class="row">
        <form role="form" method="POST" action="<?php echo base_url().strtolower($this->session->userdata('directory')); ?>/add_news_category_detail/add"  enctype="multipart/form-data">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  name="en_title" placeholder="English Title" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"><?php echo get_phrase('chinese_title'); ?>:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  name="ch_title" placeholder="Chinese Title" required>
                        </div>
                    </div>
                    <div class="form-group row">
        				<label class="col-sm-2 col-form-label"><?php echo get_phrase('category'); ?></label>
        				<div class="col-sm-10">
        					<select id="category_id" name="category_id" required="required" class="form-control" onchange="getNewsSubcategory(this.value)" >
        						<option value="" disabled selected><?php echo get_phrase('please_select'); ?></option>
        						<?php foreach($category as $lbl){ ?>
        						<option value="<?php echo $lbl['news_category_id']; ?>"> <?php echo $lbl['en_title']; ?> -- <?php echo $lbl['ch_title']; ?></option>
        						<?php } ?>
        					</select>
        				</div>
        			</div>
                    <div class="form-group row">
        				...
        				<div class="col-sm-10">
        					<select id="sub_category_id" name="sub_category_id"  class="form-control" onchange="getNewsTreecategory(this.value)">
                    ...
                    <div class="form-group row">
        				...
        				<div class="col-sm-10">
        				  <select  name="keywords_id[]" required="required" class="form-control mySelect for" multiple="multiple" style="width: 100%">
        						<?php foreach($keywords as $lbl){ ?>
        						<option value="<?php echo $lbl['keywords_id']; ?>"> <?php echo $lbl['en_title']; ?> -- <?php echo $lbl['ch_title']; ?></option>
        						<?php } ?>
        					</select>
        				</div>
        			</div>
