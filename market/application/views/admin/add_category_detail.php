...
<div class="wrapper">
	<div class="alert alert-info" style="width:100%">
	  <strong><?php echo get_phrase('info!'); ?></strong> <?php echo get_phrase('this_page_allows_you_to_add_your_category_detail_information'); ?>
	</div>
    <div class="row">
        <form role="form" method="POST" action="<?php echo base_url().strtolower($this->session->userdata('directory')); ?>/add_category_detail/add"  enctype="multipart/form-data">
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group row">
        				...
        				<div class="col-sm-10">
        					<select id="category_id" name="category_id" required="required" class="form-control" onchange="getSubcategory(this.value)" >
        						<option value="" disabled selected><?php echo get_phrase('please_select'); ?></option>
        						<?php foreach($category as $lbl){ ?>
        						<option value="<?php echo $lbl['category_id']; ?>"> <?php echo $lbl['en_title']; ?> -- <?php echo $lbl['ch_title']; ?></option>
        						<?php } ?>
        					</select>
        				</div>
        			</div>
