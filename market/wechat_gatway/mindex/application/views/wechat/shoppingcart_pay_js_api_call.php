...
try{
	...
	$input->SetGoods_tag("");
	$input->SetNotify_url(base_url()."index.php/notice/index");//设置回调网址
...
<body>
    <br /><br /><br />
	<div align="center">
		<button onclick="togotopay()" style="width:210px;height:30px; background-color:#FE6714;border:0px #FE6714 solid;cursor:pointer;color:white;font-size:16px;" type="button">
			贡献一下
		</button>
	</div>
